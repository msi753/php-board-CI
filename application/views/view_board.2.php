        ...
        <div>
            ...
            <div>
                <form action="ImgCrop" method="POST">
                    ...
                    <input type="text" name="rotate" class="rotate">

                    <br>
                    <button type="submit" class="btn btn-primary">크롭하기</button>
                </form>
                <div class="crop_button">
                    <button type="button" class="btn btn-primary" data-method="setDragMode" data-option="move">이동</button>
                    <button type="button" class="btn btn-primary" data-method="setDragMode" data-option="crop">자르기</button>
                    ...
                    <button type="button" class="btn btn-primary" data-method="rotate" data-option="-45">회전(좌)</button>
                    <button type="button" class="btn btn-primary" data-method="rotate" data-option="45">회전(우)</button>
                    <button type="button" class="btn btn-primary" data-method="reset">초기화</button>
                    <button type="button" class="btn btn-primary" data-method="getCanvasData">이미지 정보</button>
                </div>
            </div>           
            ...
            <script>
                ...
                //     alert('클릭');
                //     var $this = $(this);
                //     var data = $this.data();  //data-method에 들어있는 값과 data-option에 있는 값이 같이 넘어온다 ex){option:0.1, method="zoom"}
