...
class ImgCrop extends CI_Controller {
	...
	public function index() {
                ...
                //워터마크 속성 추가
                $config['wm_text'] = 'etoday 2019';                  //워터마크로 사용할 텍스트
                $config['wm_type'] = 'text';                         //워터마크 타입 
                $config['wm_vrt_alignment'] = 'middle';              //워터마크이미지의 세로 정렬
                $config['wm_hor_alignment'] = 'center';              //워터마크이미지의 가로 정렬
                $config['wm_padding'] = '20';                        //워터마크가 이미지로부터 얼마나 떨어지는지
                $config['wm_font_path'] = 'system/fonts/texb.ttf';   //트루타입폰트의 서버경로(왼쪽에 써진 폰트는 한글이 지원안되는 기본폰트)
                $config['wm_font_size'] = '40';                      //폰트크기
                $config['wm_font_color'] = '000000';                 //폰트색상(16진수)
